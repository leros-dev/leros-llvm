...
namespace Leros {
enum Fixups {
  // fixup_Leros_hi20 - 8-bit fixup, for byte 0 of a symbol
  fixup_leros_b0 = FirstTargetFixupKind,
  // fixup_Leros_hi20 - 8-bit fixup, for byte 1 of a symbol
  fixup_leros_b1,
  // fixup_Leros_hi20 - 8-bit fixup, for byte 2 of a symbol
  fixup_leros_b2,
  // fixup_Leros_hi20 - 8-bit fixup, for byte 3 of a symbol
  fixup_leros_b3,
